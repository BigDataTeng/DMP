...
//http://restapi.amap.com/v3/geocode/regeo?key=8919267ba3dfb2dd33c7d60d463e55f6&location=116.310003,39.991957&poitype=&radius=5&extensions=all&batch=false&roadlevel=0
...
object AmapUtil {
  ...
  def getBusinessFromAmap(long:Double,lat:Double):String={
    ...
    val urlStr = "http://restapi.amap.com/v3/geocode/regeo?key=8919267ba3dfb2dd33c7d60d463e55f6&location="+location+"&poitype=&radius=5&extensions=all&batch=false&roadlevel=0"
    // 调用请求
